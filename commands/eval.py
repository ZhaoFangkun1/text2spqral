...
from text2qdmr.utils.serialization import ComplexDecoder, ComplexEncoder
...
def main(args):
    ...
    for line in tqdm(inferred_lines):
        ...
        exact_match, exec_match, sql_hardness, question, qdmr, grounding, db_id, sql, sql_result, sparql_query, result = metrics.add(
            examples_with_name[name], inferred_code, section)
        out.write(
            json.dumps({
                'name': name,
                'question': question,
