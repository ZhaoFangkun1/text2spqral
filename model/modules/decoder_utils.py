...
def beam_search(model, preproc_item, beam_size, max_steps, strict_decoding=False):
    align_martix,general_grounding,question,[inference_state, next_choices] = model.begin_inference(preproc_item)
    ...
    return finished,align_martix.tolist(),general_grounding,question
